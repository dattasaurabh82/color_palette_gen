 ...
 *   It uses Color Quantization: Simplify the color palette of the image 
 *   to a limited number of colors. This is done using k-means clustering algorithm.
 */
...
static final String FILE = "scene1.jpg";
